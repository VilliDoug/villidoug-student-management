      ...
      <div className="flex-grow w-full max-w-sm space-y-6 text-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <Link href='/dashboard' className="w-full py-2 px-4 border text-gray-400 border-gray-400 rounded-lg hover:bg-sky-100 hover:border-sky-300 transition-colors text-sm font-medium">
            ゲスト ログイン</Link>          
        </div>
      </div>
        <Footer />
