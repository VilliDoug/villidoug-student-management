...
export default function Footer() {
  ...
  return (
    <footer className="text-gray-600 w-full">
      <div className="p-4 flex justify-center items-center sm:flex-row flex-col">
        <Link
          href="/"
          className="flex items-center md:justify-start justify-center text-gray-900"
        >
          <span className="ml-3 text-md">Student Management App</span>
        </Link>
        <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          © {date} Guilherme Moraes Migotto
        </p>
        <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          <a
