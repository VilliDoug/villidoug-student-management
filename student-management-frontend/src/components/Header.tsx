...
export default function Header ({ userName }: HeaderProps) {
    return (
        <nav className="flex items-center justify-between px-8 bg-sky-300">
            ...
            <div className="flex items-center gap-6 m-3">
                ...
                <Link href="/" className="flex gap-3 px-4 py-2 text-sm text-white font-medium border rounded-md hover:bg-red-300 transition-colors">
